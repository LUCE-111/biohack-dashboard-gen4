...
export const schedules: Readonly<Record<ScheduleKey, Schedule>> = {
  day: {
    ...
    tasks: [
      ...
      { id: 'day-wake', start: '05:40', end: '06:40', tag: 'supp', type: 'normal', title: '기상 & 유산균', description: '공복에 ⑥ 유산균. 물 한 잔.', supplementIds: ['6'] },
      { id: 'day-commute-in', start: '06:40', end: '07:40', tag: 'transit', type: 'transit', title: '출근 & 1차 카페인', description: '이동 중 커피. 아침 식사 후 ③A · ④Bone · ⑦O3 · ⑧B.', supplementIds: ['3', '4', '7', '8'] },
      ...
      { id: 'day-commute-out', start: '18:00', end: '19:00', tag: 'transit', type: 'transit', title: '퇴근 이동', description: '이완 모드 전환. 업무 생각 끄기.' },
      { id: 'day-workout', start: '19:00', end: '20:30', tag: 'rest', type: 'normal', title: '고강도 운동', description: '무산소(어깨/등/가슴) + 유산소.' },
  ...
  night: {
    ...
    tasks: [
      ...
      { id: 'night-nap', start: '14:00', end: '15:30', tag: 'sleep', type: 'sleep', title: '앵커 낮잠', description: '90분 필수 수면. 아데노신 제거.' },
      { id: 'night-prep', start: '15:40', end: '16:40', tag: 'supp', type: 'normal', title: '출근 준비', description: '⑧B-Complex 추가. 찬물 샤워. 탄수화물 식사.', supplementIds: ['8'] },
      { id: 'night-commute-in', start: '16:40', end: '17:40', tag: 'transit', type: 'transit', title: '출근 이동', description: '전투 태세 돌입.' },
      ...
      { id: 'night-commute-out', start: '08:00', end: '09:00', tag: 'transit', type: 'transit', title: '퇴근 이동', description: '선글라스 필수. ②Mg 200mg.', supplementIds: ['2'] },
    ],
